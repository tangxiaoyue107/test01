<template>
  <div class="fruit_show">
    <div class="left_study_nav">
        ...
        <router-link to="/fruit_show/article">
            <navleftlong>
              <span slot="left_nav" @click="yearchange(this.newyear)">{{$t('m.fruit_article')}}</span>
              <div slot="nav_list">
...
export default {
  ...
  methods:{
    ...
    yearchange(content){
      console.log(content);
      this.$router.push({path:"/fruit_show/article",query: {year:content}});
    },
    }
  }
